export function LinkedinCard () {
  return (
    ...
    >
      ...
      <svg className='flex justify-center items-center  h-[50px] w-[50px] sm:h-[130px] sm:w-[130px] text-white dark:text-[#ffffffaa]' xmlns='http://www.w3.org/2000/svg' fill='currentColor' viewBox='0 0 15 15'>
